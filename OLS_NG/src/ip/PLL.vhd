...
-- Module  Version: 5.2
--C:\Programme\ispTOOLS8_1\ispfpga\bin\nt\scuba.exe -w -n PLL -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 50 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -fb_mode INTERNAL -noclkos -noclkok -norst -noclkok2 -e 

-- Sat Jan 22 19:41:21 2011
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  2, CLKOP_DIV=>  8, CLKFB_DIV=>  2, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
        port map (CLKI=>CLK, CLKFB=>CLKFB_t, RST=>scuba_vlo, 
            ...
            CLKOS=>open, CLKOK=>open, LOCK=>LOCK, CLKINTFB=>CLKFB_t);
